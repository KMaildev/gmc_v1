            ...
            <center>
                ...
                <body link='blue' vlink='purple'>
                    <table border='0' cellpadding='0' cellspacing='0' width='700'
                        ...
                        <tr height='40' style='mso-height-source:userset;height:15pt'>
                        ...
                        <tr height='20' style='mso-height-source:userset;height:15pt'>
                            ...
                            <td colspan='2' class='x97'
                                style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>Discount
                            </td>
                            <td class='x50'></td>
                            <td class='x49' align='right' x:num="1000">
                                {{ number_format($sales_invoices_payment->discount, 2) }}
                            </td>
                        </tr>

                        <tr height='20' style='mso-height-source:userset;height:15pt'>
                            <td colspan='2' class='x97'
                                style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>Disposit
                            </td>
                            <td class='x50'></td>
                            <td class='x49' align='right' x:num="1000">
                                {{ number_format($sales_invoices_payment->discount, 2) }}
                        ...
                        <tr height='20' style='mso-height-source:userset;height:15pt'>
                            ...
                            <td class='x50'>{{ $sales_invoices_payment->dealer_ercentage ?? 0 }}%</td>
                        ...
                        <tr height='20' style='mso-height-source:userset;height:15pt'>
                            <td class='x28'></td>
                            <td class='x28'></td>
                            <td colspan='4' class='x97'
                                style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>TOTAL
                                BALANCE
                                TO BE PAY DATE&nbsp;</td>
                            <td class='x52' x:num="1000">
                                {{ $sales_invoices_payment->balance_to_pay_be_date ?? 'asdf' }}
                            </td>
                        </tr>
